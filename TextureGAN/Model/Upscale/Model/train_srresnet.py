...
from SpecialGenerator import SRResNet
from TextureGAN.Model.Upscale.Data.CustomDataset import CustomDataset as SRDataset

# Data parameters
data_folder = '/Users/gametekker/Documents/ML/InterpretableGAN/upscale'  # folder with JSON data files
...
def main():
    ...
    # Custom dataloaders
    train_dataset = SRDataset(f"{data_folder}/features",f"{data_folder}/labels")
